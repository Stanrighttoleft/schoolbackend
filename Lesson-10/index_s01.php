...
<head>
    ...
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Lobster&family=Noto+Sans+TC:wght@100..900&family=Noto+Serif+TC:wght@200..900&display=swap');
...
<body>
    <section id="header">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="images/logo.jpg" class="img-fluid rounded-circle" alt="店商藥妝"></a>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingTwo">
                                ...
                                <div class="accordion-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-paw">天然成分調理專區</em></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-paw">婦嬰,敏感受損調理</em></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-paw">Neogen</em></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-paw"> 萊雅</em></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-paw"> 肌研</em></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-paw"> 露得清</em></a></td>
                                        </tr>
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-user">按摩油</em></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-user">纖體保養</em></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-user">身體香氛</em></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="#"><em class="fas fa-user">身體防曬</em></a></td>
                                        </tr>
                ...
                <div class="col-md-10">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <p>保養界的藝術品！內到外優雅自成一格，堅持保養始於自然，升級膚質0負擔，讓肌膚與生活更美好。源自台灣的國際保養品牌！
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">黃金燕窩生物纖維面膜囊</h5>
