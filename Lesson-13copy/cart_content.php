...
<?php if($cart_rs->rowCount() !=0){ ?>
    ...
    <button id="btn02" name="btn02" class="btn btn-info" onclick="window.history.go(-1)">回上一頁</button>
    <button id="btn03" name="btn03" class="btn btn-success" onclick="btn_confirmLink('確定清空購物車?','shopcart_del.php?mode=2');">清空購物車</button>
    <button id="btn04" name="btn04" class="btn btn-warning" href="checkout.php">前往結帳</button>
    <!-- 響應式table物件 -->
